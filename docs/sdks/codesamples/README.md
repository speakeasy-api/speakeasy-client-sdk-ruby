...
<!-- UsageSnippet language="ruby" operationID="generateCodeSamplePreview" method="post" path="/v1/code_sample/preview" example="default" -->
```ruby
...
<!-- UsageSnippet language="ruby" operationID="getCodeSamplePreviewAsync" method="get" path="/v1/code_sample/preview/async/{jobID}" example="default" -->
```ruby
require 'speakeasy_client_sdk_ruby'
