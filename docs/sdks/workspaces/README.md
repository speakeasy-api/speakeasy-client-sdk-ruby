...
req = Models::Shared::Workspace.new(
  created_at: DateTime.iso8601('2024-11-17T13:41:10.525Z'),
  id: '<id>',
  name: '<value>',
  organization_id: '<id>',
  slug: '<value>',
  updated_at: DateTime.iso8601('2025-11-21T08:36:32.740Z'),
  verified: true,
)
...
res = s.workspaces.update_details(workspace: Models::Shared::Workspace.new(
  created_at: DateTime.iso8601('2024-08-01T22:30:24.264Z'),
  id: '<id>',
  name: '<value>',
  organization_id: '<id>',
  slug: '<value>',
  updated_at: DateTime.iso8601('2026-01-24T03:53:13.581Z'),
  verified: true,
))
...
res = s.workspaces.update_settings(workspace_settings: Models::Shared::WorkspaceSettings.new(
  ...
  created_at: DateTime.iso8601('2025-07-27T10:14:11.397Z'),
  updated_at: DateTime.iso8601('2026-12-12T17:54:28.990Z'),
))
...
res = s.workspaces.create_token(workspace_token: Models::Shared::WorkspaceToken.new(
  ...
  alg: '<value>',
  key: '<key>',
  created_at: DateTime.iso8601('2025-10-04T10:23:04.522Z'),
))
