...
module SpeakeasyClientSDK
  module Operations
    ...
    class InsertVersionMetadataRequest < ::SpeakeasyClientSDK::Utils::FieldAugmented
      ...
      field :version_metadata, ::SpeakeasyClientSDK::Shared::VersionMetadataInput, { 'request': { 'media_type': 'application/json' } }


      sig { params(api_id: ::String, version_id: ::String, version_metadata: ::SpeakeasyClientSDK::Shared::VersionMetadataInput).void }
