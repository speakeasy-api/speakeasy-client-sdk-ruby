...
module OpenApiSDK
	module Operations
		...
		class UpsertApiEndpointPathParams < OpenApiSDK::Utils::FieldAugmented
			extend T::Sig
		...
		class UpsertApiEndpointRequest < OpenApiSDK::Utils::FieldAugmented
			extend T::Sig
			field :path_params, UpsertApiEndpointPathParams
			field :request, Shared::ApiEndpointInput, metadata={'request': { 'media_type': 'application/json' }}

			sig{params(path_params: UpsertApiEndpointPathParams, request: Shared::ApiEndpointInput).void }
