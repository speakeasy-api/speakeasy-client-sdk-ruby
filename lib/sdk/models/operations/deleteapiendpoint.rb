...
module OpenApiSDK
	module Operations
		...
		class DeleteApiEndpointPathParams < OpenApiSDK::Utils::FieldAugmented
			extend T::Sig
		...
		class DeleteApiEndpointRequest < OpenApiSDK::Utils::FieldAugmented
			extend T::Sig
			field :path_params, DeleteApiEndpointPathParams

			sig{params(path_params: DeleteApiEndpointPathParams).void }
		...
		class DeleteApiEndpointResponse < OpenApiSDK::Utils::FieldAugmented
			extend T::Sig
