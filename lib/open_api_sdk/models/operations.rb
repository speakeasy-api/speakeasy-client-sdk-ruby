...
module OpenApiSDK
  module Operations
    ...
    autoload :ListRegistrySubscriptionsRequest, 'open_api_sdk/models/operations/listregistrysubscriptions_request.rb'
    autoload :ListRegistrySubscriptionsResponse, 'open_api_sdk/models/operations/listregistrysubscriptions_response.rb'
    autoload :CreateSubscriptionRequest, 'open_api_sdk/models/operations/createsubscription_request.rb'
    autoload :CreateSubscriptionResponse, 'open_api_sdk/models/operations/createsubscription_response.rb'
  end
end
