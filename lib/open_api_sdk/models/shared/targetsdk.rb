  ...
  module Models
    module Shared
      ...
      class TargetSDK
        ...
        field :last_event_created_at, ::DateTime, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('last_event_created_at'), required: true, 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(false) } }
        # Type of interaction.
        field :last_event_interaction_type, Models::Shared::InteractionType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('last_event_interaction_type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::InteractionType, false) } }
        ...
        field :last_publish_created_at, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('last_publish_created_at'), 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(true) } }
