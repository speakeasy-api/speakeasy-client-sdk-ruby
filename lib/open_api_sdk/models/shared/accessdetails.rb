  ...
  module Models
    module Shared
      ...
      class AccessDetails
        ...
        field :level, Crystalline::Nilable.new(Models::Shared::Level), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('level'), 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::Level, true) } }
