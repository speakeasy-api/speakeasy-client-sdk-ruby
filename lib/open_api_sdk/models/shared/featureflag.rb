  ...
  module Models
    module Shared
      ...
      class FeatureFlag
        ...
        field :feature_flag, Models::Shared::WorkspaceFeatureFlag, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('feature_flag'), required: true, 'decoder': Utils.open_enum_from_string(Models::Shared::WorkspaceFeatureFlag, false) } }
