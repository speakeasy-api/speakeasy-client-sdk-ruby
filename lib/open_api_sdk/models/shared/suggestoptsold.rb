  ...
  module Models
    module Shared
      ...
      class SuggestOptsOld
        ...
        field :suggestion_type, Models::Shared::SuggestionType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('suggestion_type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::SuggestionType, false) } }
