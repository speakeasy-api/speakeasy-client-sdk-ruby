  ...
  module Models
    module Shared
      ...
      class Workspaces
        ...
        field :account_type, Crystalline::Nilable.new(Models::Shared::AccountType), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('account_type'), 'decoder': Utils.open_enum_from_string(Models::Shared::AccountType, true) } }
