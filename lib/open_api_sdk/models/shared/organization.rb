  ...
  module Models
    module Shared
      ...
      class Organization
        ...
        field :account_type, Models::Shared::AccountType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('account_type'), required: true, 'decoder': Utils.open_enum_from_string(Models::Shared::AccountType, false) } }
