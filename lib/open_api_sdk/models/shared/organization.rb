  ...
  module Models
    module Shared
      ...
      class Organization
        ...
        field :account_type, Models::Shared::AccountType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('account_type'), required: true, 'decoder': ::OpenApiSDK::Utils.open_enum_from_string(Models::Shared::AccountType, false) } }
        ...
        field :updated_at, ::DateTime, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('updated_at'), required: true, 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(false) } }
        ...
        field :free_trial_expiry, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('free_trial_expiry'), 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(true) } }
