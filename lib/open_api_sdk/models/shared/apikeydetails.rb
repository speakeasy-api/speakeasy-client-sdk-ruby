  ...
  module Models
    module Shared
      ...
      class ApiKeyDetails
        ...
        field :account_type_v2, Models::Shared::AccountType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('account_type_v2'), required: true, 'decoder': Utils.open_enum_from_string(Models::Shared::AccountType, false) } }
