  ...
  module Models
    module Shared
      ...
      class ApiKeyDetails
        ...
        field :account_type_v2, Models::Shared::AccountType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('account_type_v2'), required: true, 'decoder': ::OpenApiSDK::Utils.open_enum_from_string(Models::Shared::AccountType, false) } }
        ...
        field :workspace_created_at, ::DateTime, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('workspace_created_at'), required: true, 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(false) } }
