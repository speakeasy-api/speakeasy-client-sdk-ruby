  ...
  module Models
    module Shared
      ...
      class WorkspaceTeamResponse
        ...
        field :users, T::Array[Models::Shared::User], { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('users') } }
        # SSO metadata for a workspace
        field :sso_metadata, T.nilable(Models::Shared::SSOMetadata), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('sso_metadata') } }
