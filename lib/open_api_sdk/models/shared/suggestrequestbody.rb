  ...
  module Models
    module Shared
      ...
      class SuggestRequestBody
        ...
        field :suggestion_type, Models::Shared::SuggestRequestBodySuggestionType, { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('suggestion_type'), required: true, 'decoder': ::OpenApiSDK::Utils.enum_from_string(Models::Shared::SuggestRequestBodySuggestionType, false) } }
