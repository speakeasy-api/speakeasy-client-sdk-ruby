  ...
  module Models
    module Operations
      ...
      class GetRevisionsRequest
        ...
        field :next_page_token, Crystalline::Nilable.new(::String), { 'query_param': { 'field_name': 'next_page_token', 'style': 'form', 'explode': true } }

        sig { params(namespace_name: ::String, next_page_token: T.nilable(::String)).void }
        def initialize(namespace_name:, next_page_token: nil)
