...
module OpenApiSDK
  module Operations
    ...
    class UpsertApiEndpointRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :api_endpoint, ::OpenApiSDK::Shared::ApiEndpointInput, { 'request': { 'media_type': 'application/json' } }
      ...
      sig { params(api_endpoint: ::OpenApiSDK::Shared::ApiEndpointInput, api_endpoint_id: ::String, api_id: ::String, version_id: ::String).void }
