...
module OpenApiSDK
  module Operations
    ...
    class RegisterSchemaRequest < ::OpenApiSDK::Utils::FieldAugmented
      ...
      field :request_body, ::OpenApiSDK::Operations::RegisterSchemaRequestBody, { 'request': { 'media_type': 'multipart/form-data' } }
      # The version ID of the Api to delete metadata for.
      field :version_id, ::String, { 'path_param': { 'field_name': 'versionID', 'style': 'simple', 'explode': false } }


      sig { params(api_id: ::String, request_body: ::OpenApiSDK::Operations::RegisterSchemaRequestBody, version_id: ::String).void }
