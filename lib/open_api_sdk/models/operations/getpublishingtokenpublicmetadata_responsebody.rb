  ...
  module Models
    module Operations
      ...
      class GetPublishingTokenPublicMetadataResponseBody
        ...
        field :valid_until, Crystalline::Nilable.new(::DateTime), { 'format_json': { 'letter_case': ::OpenApiSDK::Utils.field_name('valid_until'), 'decoder': ::OpenApiSDK::Utils.datetime_from_iso_format(true) } }
