...
module OpenApiSDK
  module Operations
    ...
    class GenerateRequestPostmanCollectionResponse < ::OpenApiSDK::Utils::FieldAugmented
      ...
      sig { params(content_type: ::String, raw_response: ::Faraday::Response, status_code: ::Integer, error: T.nilable(::OpenApiSDK::Shared::Error), postman_collection: T.nilable(::String)).void }
