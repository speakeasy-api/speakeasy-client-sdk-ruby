...
module OpenApiSDK
  ...
  class ShortURLs
    ...
    sig { params(request: Models::Operations::CreateRequestBody, timeout_ms: T.nilable(Integer), http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])).returns(Models::Operations::CreateResponse) }
    def create(request:, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ['2XX'])
        if Utils.match_content_type(content_type, 'application/json')
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Shared::ShortURL)
          response = Models::Operations::CreateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            short_url: T.unsafe(obj)
          )
